...
* { path: "politicaVinculados", loadChildren: "./politicaVinculados/politicaVinculados.module#PoliticaVinculadosModule" }
* Note that this simply points the path to the page module file. If you move the page, you need to update the route too.
*************************************************************/

@Component({
    selector: "PoliticaVinculados",
    moduleId: module.id,
    templateUrl: "./politicaVinculados.component.html"
})
export class PoliticaVinculadosComponent implements OnInit {
    vinculo:string;
    constructor() {
    }
